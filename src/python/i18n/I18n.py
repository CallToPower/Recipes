...
_translations_en = {
    ...
    'GUI.RECIPE.HEADERS.QUANTITY': 'Quantity',
    'GUI.RECIPE.HEADERS.NAME': 'Name',
    'GUI.RECIPE.HEADERS.ADDITION': 'Further Information',
...
_translations_de = {
    ...
    'GUI.RECIPE.VIEW.HEADERS.LINKS': 'Links',
    'GUI.RECIPE.HEADERS.QUANTITY': 'Anzahl',
    'GUI.RECIPE.HEADERS.NAME': 'Name',
    'GUI.RECIPE.HEADERS.ADDITION': 'Weitere Angaben',
